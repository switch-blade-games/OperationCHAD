...
global.pad_left[0] = buffer_read(buff,buffer_u16);
global.pad_right[0] = buffer_read(buff,buffer_u16);
global.pad_up[0] = buffer_read(buff,buffer_u16);
global.pad_down[0] = buffer_read(buff,buffer_u16);
global.pad_jump[0] = buffer_read(buff,buffer_u16);
global.pad_fire[0] = buffer_read(buff,buffer_u16);
global.pad_lock[0] = buffer_read(buff,buffer_u16);
