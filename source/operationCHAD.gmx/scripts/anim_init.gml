...
EXP_GROUP[anim.wc] = 2;
EXP_GROUP[anim.wc_fire] = 3;
EXP_GROUP[anim.mb] = 4;
EXP_GROUP[anim.mb_fire] = 5;
EXP_GROUP[anim.moto] = 6;
EXP_GROUP[anim.moto_fire] = 7;
EXP_GROUP[anim.roll] = 8;
EXP_GROUP[anim.dead_roll] = 9;
EXP_GROUP[anim.dead] = 10;
// expected tags
...
EXP_TAG[anim.idle,0]           = "F_0";
EXP_TAG[anim.idle,1]           = "F_45";
EXP_TAG[anim.idle,2]           = "F_90";
EXP_TAG[anim.idle,3]           = "F_270";
EXP_TAG[anim.idle,4]           = "F_315";
