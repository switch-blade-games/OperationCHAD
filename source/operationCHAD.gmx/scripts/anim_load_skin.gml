...
anim_create(anim.idle_ramp_u,0,1,2,1,0,4,3,4);
anim_create(anim.duck_ramp_u);
anim_create(anim.wc_fire,0,1,2,3,4,5,6,7);
anim_create(anim.wc);
anim_create(anim.mb_fire,0,1,2,1,0,4,3,4);
anim_create(anim.mb);
anim_create(anim.moto_fire,0,1,2,3,4,5,6,7);
anim_create(anim.moto);
anim_create(anim.roll);
anim_create(anim.dead_roll);
