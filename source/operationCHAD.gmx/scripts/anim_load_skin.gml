...
anim_create(aState.ramp_u_duck_idle);
anim_create(aState.ramp_u_duck_fire);
anim_create(aState.ramp_d_idle);
anim_create(aState.ramp_d_fire,0,1,2,1,0,4,3,4);
anim_create(aState.ramp_d_duck_idle);
anim_create(aState.ramp_d_duck_fire);
...
switch(skin_id)
    ...
    case skin.stone:
        ...
        img_speed[aState.ramp_u_duck_idle] = 0.2;
        img_speed[aState.ramp_u_duck_fire] = 0.2;
        img_speed[aState.ramp_d_idle] = 0.2;
        img_speed[aState.ramp_d_fire] = 0.2;
        img_speed[aState.ramp_d_duck_idle] = 0.2;
        img_speed[aState.ramp_d_duck_fire] = 0.2;
